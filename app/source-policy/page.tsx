  ...
  return (
    <main>
      ...
      <section className="shell content-shell simple-grid">
        ...
        <article className="prose-card"><h3>Freshness</h3><p>When a fact is time-sensitive, Admin stores last-checked and last-verified timestamps. Stale does not mean false — it means it needs another look before you treat it as current.</p></article>
      </section>
    </main>
  );
}
