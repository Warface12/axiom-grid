...
const STATIC = ["/", "/about", "/exchanges", "/brokers", "/wallets", "/research", "/updates", "/compare", "/learn", "/markets", "/fees", "/security", "/how-we-rate", "/editorial-policy", "/corrections", "/contact", "/legal/affiliate-disclosure", "/legal/risk-disclosure", "/legal/privacy", "/legal/cookies", "/legal/terms"];
