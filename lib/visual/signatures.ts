...
export const SIGNATURES: Record<string, CategorySignature> = {
  ...
  options: { id: "options", accent: "#7ea2ff", glow: "rgba(126,162,255,.26)", object: "venue" },
  restaking: { id: "restaking", accent: "#8be0a8", glow: "rgba(139,224,168,.24)", object: "node" },
  rwa: { id: "rwa", accent: "#d7c4a0", glow: "rgba(215,196,160,.2)", object: "ledger" },
  prediction: { id: "prediction", accent: "#ffb36a", glow: "rgba(255,179,106,.22)", object: "lens" },
  lending: { id: "lending", accent: "#6ef0c4", glow: "rgba(110,240,196,.26)", object: "vault" },
  privacy: { id: "privacy", accent: "#9ad0ff", glow: "rgba(154,208,255,.22)", object: "keys" },
  gamefi: { id: "gamefi", accent: "#c9a0ff", glow: "rgba(201,160,255,.26)", object: "hex" },
